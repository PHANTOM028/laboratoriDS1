...
<html>
    ...
    <td>
        <button class="open-popup-btn" onclick="mostrarDetallesEmpleado(
            '${item.idEmpleado}',
            '${item.dui}',
            '${item.isss}',
    ...
    <script>
        ...
        function mostrarDetallesEmpleado(ID_Empleado, DUI_Empleado, ISSS_Empleado, nombresEmpleado, apellidosEmpleado, telefonoEmpleado, cargo, direccionCompleta) {
